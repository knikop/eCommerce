...
<body>
    <nav>
        <div class="nav-wrapper">
            <img src="https://raw.githubusercontent.com/knikop/eCommerce/main/app/views/img/logo.PNG" class="brand-img" alt="">
            <input type="text" class="search-box" placeholder="search">
            <div class="nav-items">
                <img src="https://raw.githubusercontent.com/knikop/eCommerce/main/app/views/img/home.PNG" class="icon" alt="">
				...
				<a href="/login/logout" class="icon">Logout</a>
